...
- For missing key items that gate progress, consult the Fuse recovery guidance on the Fuse page: [Fuse]({{page:up-achievement-fuses}}).
...
4. For missing key items that prevent progression, check your backups and the [Fuse]({{page:up-achievement-fuses}}) recovery guidance.
...
- For missing key-item guidance, see [Fuse]({{page:up-achievement-fuses}})
