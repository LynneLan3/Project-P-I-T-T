...
export const EXPECTED_REPOSITORY_ID = 'LynneLan3/Project-P-I-T-T';
		...
		if (!normalized) {
			...
			errors.push(
				[
					...
					`  fix: Use LynneLan3/Project-P-I-T-T only. Do not silently fall back to content markers when a remote exists.`,
				].join('\n'),
			);
		} else {
