# Project P.I.T.T. Guide

Standalone Astro + Starlight guide site for Project P.I.T.T.

## Production validation

The starter architecture was first production-validated through the Agefield High migration.

This repository is generated from the shared `game-wiki-starter` template. Keep site-specific content in `site-spec.yaml` and `site-input/`; do not modify the template checkout.
