# AGENTS.md — Project P.I.T.T.

Rules every Codex session in this repository must follow.

## Repository identity

- This repository is always `LynneLan3/Project-P-I-T-T`.
- Machine-readable marker: root file `REPOSITORY_ID` must contain exactly `LynneLan3/Project-P-I-T-T`.
- This is an independent standalone site. Do not develop in or modify `game-wiki-starter`.
- Do not switch the working remote to another repository.
- Before site generation, run `npm run verify:context`.
