...
quickAnswer: "Basic ducks are not the right input for the post-200kg Percentage Pipe. Continue the production progression until you can feed later-stage or assembled products, then follow the connected Secret Ending route."
related:
  - 200kg-plate
  - secret-ending
...
1. Finish the 200kg stage (see [the 200kg Guide](/200kg-plate/)).
...
- If you’re stuck at 200kg, follow [the 200kg Guide](/200kg-plate/) to finish that checkpoint.
...
- Once IGTAP is active, follow the connected steps toward the Secret Ending; start with [the Secret Ending Guide](/secret-ending/) for the next phase.

Related Guides

- [the 200kg Guide](/200kg-plate/)
