...
quickAnswer: "Start with one short visible recoverable lane, balance Duck, Cash Register, and Piñata on separate lanes before merge, use 1.0.7 Pistons for attached tools, then link Shift Scheduler, Trade Terminal, Panel Rack, and Anomaly Phase 4 before x300."
related:
  - anomaly-phase-4
  - shift-scheduler
  - trade-terminal
...
changeSummary: "Expanded Phase 4 hub with three-input staging, 1.0.7 Pistons, and Anomaly Phase 4 cross-link."
...
facts:
  ...
  -
    label: Pistons 1.0.7
    value: "Tools stick to piston head; off locks position; on resumes motion"
  -
    label: Next step
