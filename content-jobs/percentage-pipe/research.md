...
PLAYER PROBLEM
After reaching 200kg, players throw ordinary ducks into the Percentage Pipe and still see 0%. They need to know whether this is a bug, what progression they should follow, and how the pipe connects to the Secret Ending route.

VERIFIED FACTS
- The Percentage Pipe is the progression after the 200kg stage.
- Ordinary/basic ducks are not the correct answer for moving the percentage in this later stage.
...
DO NOT CLAIM
- Do not call the 0% display a universal bug without evidence.
- Do not invent the exact percentage increments, product recipe, item count, room location, or an exact completion percentage route.
- Do not present old Demo advice as current Full Release advice.
