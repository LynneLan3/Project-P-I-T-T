...
- Preserve the Fuse / Fuse Box / UP? intent and existing slug. Do not create a separate lost-fuse page.
- Explain how to use a Fuse, where it goes, how the Fuse Box works, and what to do after finding a Fuse.
